...
def set_line_component(line_area_pd, line_endarea_pd, table, search_map, base_point, target_image, canvas_image, body_pinmap, vol_pinmap, find_pincoords_line_model):
    '''
...
def set_resistor_component(resistor_area_pd, search_map, base_point, target_image, canvas_image, body_pinmap, vol_pinmap, find_pincoords_resi_model):
    '''
